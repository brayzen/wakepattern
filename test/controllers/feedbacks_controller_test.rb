...
class FeedbacksControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post feedbacks_url, params: { feedback: { text: @feedback.text, userRated: @feedback.userRated } }
  #   end
  ...
  #   patch feedback_url(@feedback), params: { feedback: { text: @feedback.text, userRated: @feedback.userRated } }
